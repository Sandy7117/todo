...
const Signup = () => {
  ...
  const submitHandler = () => {
    ...
    axios
      .post(
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCZgW-9OKp0kuqAm6UTgb2iHlrSDHbzlcI",
        userLoginData,
        {
          headers: {
    ...
    axios
      .post(
        "https://newtodo-c2203-default-rtdb.firebaseio.com/userDetails.json",
        userDetails,
        {
          headers: {
            "content-type": "application/json",
